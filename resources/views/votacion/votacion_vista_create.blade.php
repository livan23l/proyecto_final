<x-template-principal>
    <h1>Creación de votación</h1>
    <hr />
    <div class="contianer">
        <div class="row d-flex justify-content-center">
            <div class="col-sm-12 col-md-10 col-lg-8 col-xl-8">
                <form class="form" action="{{ route('votacion.index') }}" method="POST">
                    @csrf
                    <div class="card">
                        <div class="card-body">
                            <h1 class="card-title text-center">Nueva votación</h1>
                            <hr />

                            <li class="list-group list-group-flush"> <!-- Nombre -->
                                <div class="form-floating mt-2 mb-1">
                                    <input class="form-control" type="text" name="nombre" placeholder="nombre" value="{{ old('nombre') }}" required minlength="5" maxlength="255" />
                            ...
                            <li class="list-group mt-2 mb-3"> <!-- Tipo -->
                                ...
                                <select name="tipo" id="select_tipo" class="form-select" aria-label="Default select example">
                                    <option {{ old('tipo') == "Presidencial" ? 'selected' : '' }} value="Presidencial" selected>Presidencial</option>
                                    <option {{ old('tipo') == "Diputación" ? 'selected' : '' }} value="Diputación">Diputación</option>
                                    <option {{ old('tipo') == "Senaduría" ? 'selected' : '' }} value="Senaduría">Senaduría</option>
                                </select>
                                @error('tipo')
                                    <div class="alert alert-danger alert-dismissible fade show mt-2" role="alert">
                                        <i class="bi bi-exclamation-triangle me-1"></i>
                                ...
                                <div class="py-1 d-flex justify-content-center align-items-center border rounded-2">
                                    ...
                                    <div class="d-flex justify-content-center align-items-center">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" name="alcance" type="radio" id="alcance_estatal" value="Estatal" {{ old('alcance') == "Estatal" ? 'checked' : '' }}>
                            ...
                            <li class="list-group mt-2 mb-3"> <!-- Zona -->
                                <div id="lista_zona" class="{{ old('alcance') == "Estatal" ? '' : 'd-none' }}"> <!-- Solo se mostrará si escoge "estatal" -->
                                            ...
                                            <div class="modal-body">
                                                <ul class="list-unstyled">
                                                    @foreach ($candidatos as $candidato)
                                                        <li class="my-1 mx-2">
                                                            <input type="checkbox" id="candidato_{{ $candidato->id }}" name="candidatos[]" value="{{ $candidato->id }}" {{ (is_array(old('candidatos')) && in_array($candidato->id, old('candidatos'))) ? 'checked' : '' }}>
