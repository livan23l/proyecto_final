...
<head>
    ...
    <!-- Favicons -->
    <link href="{{ asset('NiceAdminassets/img/favicon.png') }}" rel="icon">
    <link href="{{ asset('NiceAdminassets/img/apple-touch-icon.png') }}" rel="apple-touch-icon">
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="/" class="logo d-flex align-items-center">
                <img src="{{ asset('NiceAdminassets/img/logo.png') }}" alt="">
