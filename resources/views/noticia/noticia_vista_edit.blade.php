                    ...
                    <div class="card">
                        <div class="card-body">
                                ...
                                <div class="py-1 d-flex justify-content-center align-items-center border rounded-2">
                                    ...
                                    <div class="d-flex justify-content-center align-items-center">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" name="origen" type="radio" id="origen_estatal" value="Estatal" {{ $noticia->origen == 'Estatal' ? 'checked' : '' }}>
                            ...
                            <li class="list-group mt-3 mb-2"> <!-- Zona -->
                                <div id="lista_zona" class="{{ $noticia->origen == 'Estatal' ? '' : 'd-none' }}"> <!-- Solo se mostrará si escoge "estatal" -->
                            ...
                            <input type="hidden" name="categ_select" id="categ_select" value="{{ $noticia->categ_select }}" />
