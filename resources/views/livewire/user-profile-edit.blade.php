<div>
    <form action="#" method="#">
        <div class="row mb-3 align-items-center"> <!-- Imagen -->
            ...
            <div class="col-md-8 col-lg-9">
                <div class="">
                    @if ($message)
                        <p><i>Guarda los cambios para ver la foto de perfil</i></p>
                ...
                <input id="profile_photo" type="file" class="btn btn-primary btn-sm mx-1 d-none" alt="Cambiar foto de perfil" title="Cambiar foto de perfil" wire:model="photo" x-ref="photo" wire:key="update-photo" wire:change="updateProfilePhoto" />

                <div class="pt-2">
                    <a href="#" class="btn btn-primary btn-sm mx-1" alt="Cambiar foto de perfil" title="Cambiar foto de perfil" x-on:click="$refs.photo.click()"><i class="bi bi-upload"></i></a>
    ...
    <div id="changes-profile-message" class="text-center mt-2"> <!-- Alertas -->
